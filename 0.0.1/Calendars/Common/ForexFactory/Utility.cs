...
namespace My.Calendars.Common.ForexFactory
{
	public static class Utility
	{
		...
		public static CalendarType ToCalendarType(this string input)
		{
			switch (input.ToLower())
			{
				case "metal":
					return CalendarType.Metal;
				default:
					return CalendarType.Forex;
			}
		}
